...
RUN apt-get update \
    && apt-get install -y --no-install-recommends \
       ...
       # zlib1g-dev \
       xz-utils \
    && curl -SL https://www.cpan.org/src/5.0/perl-5.30.0.tar.xz -o perl-5.30.0.tar.xz \
    && echo 'ac501cad4af904d33370a9ea39dbb7a8ad4cb19bc7bc8a9c17d8dc3e81ef6306 *perl-5.30.0.tar.xz' | sha256sum -c - \
    && tar --strip-components=1 -xaf perl-5.30.0.tar.xz -C /usr/src/perl \
    && rm perl-5.30.0.tar.xz \
    && cat *.patch | patch -p1 \
